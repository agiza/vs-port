...
class __TwigTemplate_6b43b374ef568bda1b839f24c272a39b708f52d1376e77638d681acf1a9610d5 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
     ...
     data-standalone=\"";
        // line 2
        echo twig_escape_filter($this->env, ((array_key_exists("mapIsStandaloneNotWidget", $context)) ? (_twig_default_filter($this->getContext($context, "mapIsStandaloneNotWidget"), 0)) : (0)), "html", null, true);
        echo "\"
     data-config=\"";
        // line 3
        echo twig_escape_filter($this->env, twig_jsonencode_filter($this->getContext($context, "config")), "html", null, true);
        echo "\"
     tabindex=\"0\">
    ...
    <div class=\"RealTimeMap_container\">
        ...
        <div class=\"realTimeMap_overlay\">
            ";
        // line 9
        if ((($this->getAttribute($this->getContext($context, "config", true), "showFooterMessage", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getContext($context, "config", true), "showFooterMessage"), true)) : (true))) {
            // line 10
        ...
        ";
        // line 18
        if ((($this->getAttribute($this->getContext($context, "config", true), "showDateTime", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getContext($context, "config", true), "showDateTime"), true)) : (true))) {
            // line 19
