...
class __TwigTemplate_3f9aaf2051902133f645cba9c8bff9647a8b482498691ce6594f1f6f542bf4b5 extends Twig_Template
{
    ...
    <form id='addEditReport'>
        ...
        echo "
            ...
            ";
        // line 30
        if ($this->getContext($context, "segmentEditorActivated")) {
            // line 31
            echo "            <tr>
                <td class=\"first\">";
            // line 32
            ...
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "savedSegmentsById"));
            foreach ($context['_seq'] as $context["savedSegmentId"] => $context["savedSegmentName"]) {
                // line 37
                echo "                            <option value=\"";
                echo twig_escape_filter($this->env, $this->getContext($context, "savedSegmentId"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, twig_slice($this->env, $this->getContext($context, "savedSegmentName"), 0, 50), "html", null, true);
                echo "</option>
                        ";
            }
            ...
            // line 44
            echo "                        ";
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("ScheduledReports_Segment_Help", "<a href=\"./\" target=\"_blank\">", "</a>", $this->getContext($context, "SegmentEditor_DefaultAllVisits"), $this->getContext($context, "SegmentEditor_AddNewSegment")));
            echo "
                    </div>
                </td>
            </tr>
        ...
        // line 53
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "periods"));
        foreach ($context['_seq'] as $context["periodId"] => $context["period"]) {
            // line 54
            echo "                            <option value=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "periodId"), "html", null, true);
            echo "\">
                                ";
            // line 55
        ...
        echo "
            ...
            <tr ";
        // line 72
        if ((twig_length_filter($this->env, $this->getContext($context, "reportTypes")) == 1)) {
        ...
        // line 78
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "reportTypes"));
        foreach ($context['_seq'] as $context["reportType"] => $context["reportTypeIcon"]) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getContext($context, "reportType")), "html", null, true);
            echo "</option>
                        ";
        }
        $_parent = $context['_parent'];
        ...
        // line 91
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "reportFormatsByReportType"));
        foreach ($context['_seq'] as $context["reportType"] => $context["reportFormats"]) {
            ...
            // line 93
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "reportFormats"));
            foreach ($context['_seq'] as $context["reportFormat"] => $context["reportFormatIcon"]) {
                // line 94
                echo "                                <option value=\"";
                echo twig_escape_filter($this->env, $this->getContext($context, "reportFormat"), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, twig_upper_filter($this->env, $this->getContext($context, "reportFormat")), "html", null, true);
                echo "</option>
                            ";
            }
            $_parent = $context['_parent'];
        ...
        // line 110
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "displayFormats"));
        foreach ($context['_seq'] as $context["formatValue"] => $context["formatLabel"]) {
            // line 111
            echo "                            <option ";
            if (($this->getContext($context, "formatValue") == 1)) {
                echo "selected";
            }
            echo " value=\"";
            echo twig_escape_filter($this->env, $this->getContext($context, "formatValue"), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getContext($context, "formatLabel"), "html", null, true);
            echo "</option>
                        ";
        }
        $_parent = $context['_parent'];
        ...
        // line 126
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getContext($context, "reportsByCategoryByReportType"));
        foreach ($context['_seq'] as $context["reportType"] => $context["reportsByCategory"]) {
            ...
            echo "'>
                            ...
                            ";
            // line 129
            if ($this->getAttribute($this->getContext($context, "allowMultipleReportsByReportType"), $this->getContext($context, "reportType"), array(), "array")) {
                // line 130
                echo "                                ";
            ...
            echo "
                            ";
            // line 137
            $context["newColumnAfter"] = intval(floor(((twig_length_filter($this->env, $this->getContext($context, "reportsByCategory")) + 1) / 2)));
            // line 138
            echo "
                            <div id='leftcolumn'>
                                ";
            // line 140
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getContext($context, "reportsByCategory"));
            foreach ($context['_seq'] as $context["category"] => $context["reports"]) {
                // line 141
                echo "                                ";
                if ((($this->getContext($context, "countCategory") >= $this->getContext($context, "newColumnAfter")) && ($this->getContext($context, "newColumnAfter") != 0))) {
                    // line 142
                    echo "                                ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["report"]) {
                    ...
                    echo "                                        <li>
                                            <input type='";
                    // line 150
                    echo twig_escape_filter($this->env, $this->getContext($context, "reportInputType"), "html", null, true);
                    echo "' id=\"";
                    echo twig_escape_filter($this->env, $this->getContext($context, "reportType"), "html", null, true);
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "report"), "uniqueId"), "html", null, true);
                    ...
                    echo "\">
                                                ";
                    // line 153
                    echo $this->getAttribute($this->getContext($context, "report"), "name");
                    echo "
                                                ";
                    // line 154
                    if (($this->getAttribute($this->getContext($context, "report"), "uniqueId") == "MultiSites_getAll")) {
                        // line 155
                        echo "                                                    <div class=\"entityInlineHelp\">";
                        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("ScheduledReports_ReportIncludeNWebsites", $this->getContext($context, "countWebsites"))), "html", null, true);
                        // line 156
                        echo "</div>
                                                ";
                    }
                ...
                // line 161
                echo "                                    ";
                $context["countCategory"] = ($this->getContext($context, "countCategory") + 1);
                // line 162
                echo "                                </ul>
                                <br/>
                                ";
...
";
    ...
    {
        return array (  448 => 179,  435 => 168,  427 => 165,  419 => 162,  416 => 161,  408 => 158,  404 => 156,  401 => 155,  399 => 154,  395 => 153,  390 => 152,  386 => 151,  377 => 150,  374 => 149,  370 => 148,  364 => 146,  359 => 143,  356 => 142,  353 => 141,  349 => 140,  345 => 138,  343 => 137,  340 => 136,  338 => 135,  335 => 134,  332 => 133,  329 => 132,  326 => 131,  323 => 130,  321 => 129,  315 => 127,  311 => 126,  306 => 124,  297 => 118,  290 => 113,  275 => 111,  271 => 110,  263 => 106,  251 => 98,  233 => 94,  229 => 93,  220 => 91,  213 => 87,  205 => 81,  194 => 79,  190 => 78,  183 => 74,  176 => 72,  168 => 67,  163 => 65,  158 => 63,  153 => 61,  148 => 58,  139 => 55,  130 => 53,  107 => 43,  103 => 42,  87 => 37,  79 => 35,  73 => 32,  70 => 31,  61 => 26,  53 => 21,  46 => 17,  23 => 3,  259 => 103,  256 => 101,  249 => 98,  246 => 97,  244 => 96,  241 => 95,  230 => 90,  224 => 92,  217 => 83,  211 => 81,  204 => 76,  200 => 75,  196 => 74,  191 => 73,  187 => 70,  181 => 67,  177 => 66,  172 => 65,  170 => 64,  160 => 61,  155 => 60,  149 => 58,  146 => 57,  142 => 54,  136 => 52,  134 => 54,  128 => 48,  124 => 50,  121 => 49,  115 => 43,  112 => 44,  97 => 37,  88 => 31,  83 => 36,  67 => 20,  63 => 19,  58 => 16,  56 => 15,  49 => 11,  45 => 10,  41 => 15,  37 => 8,  33 => 10,  29 => 6,  25 => 5,  19 => 1,  118 => 40,  114 => 39,  110 => 41,  106 => 40,  102 => 38,  98 => 39,  94 => 34,  86 => 29,  82 => 28,  78 => 26,  71 => 22,  68 => 30,  66 => 20,  62 => 19,  57 => 18,  55 => 17,  47 => 12,  42 => 9,  40 => 8,  36 => 6,  34 => 5,  31 => 4,  28 => 3,);
    }
}
