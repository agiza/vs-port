...
class __TwigTemplate_3dc4cd883f7f23e8072b21a55cd70a0392534e61bd63d90ca4354257fb02c05e extends Twig_Template
{
...
";
    ...
    <ul>
        <li>";
            // line 20
            echo twig_escape_filter($this->env, $this->getContext($context, "helpMessage"), "html", null, true);
            echo "</li>
    </ul>
    </p>
    <p>";
...
";
            ...
            <p><img src=\"plugins/Zeitgeist/images/warning_medium.png\"/> ";
                // line 35
    ...
    ";
            // line 43
            if ((twig_length_filter($this->env, $this->getContext($context, "errorMessages")) > 0)) {
                // line 44
                echo "        <div class=\"warning\">
            <p><img src=\"plugins/Zeitgeist/images/error_medium.png\"/> ";
                // line 45
            ...
            ";
                // line 51
                if ((array_key_exists("deactivatedPlugins", $context) && (twig_length_filter($this->env, $this->getContext($context, "deactivatedPlugins")) > 0))) {
                    // line 52
                    echo "                ";
                    $context["listOfDeactivatedPlugins"] = twig_join_filter($this->getContext($context, "deactivatedPlugins"), ", ");
                    // line 53
                    echo "                <p style=\"color:red;\">
                    <img src=\"plugins/Zeitgeist/images/error_medium.png\"/>
                    ";
                    // line 55
                    echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreUpdater_WeAutomaticallyDeactivatedTheFollowingPlugins", $this->getContext($context, "listOfDeactivatedPlugins"))), "html", null, true);
                    echo "
                </p>
            ";
                }
    ...
    ";
            // line 61
            if (((twig_length_filter($this->env, $this->getContext($context, "errorMessages")) > 0) || (twig_length_filter($this->env, $this->getContext($context, "warningMessages")) > 0))) {
                // line 62
                echo "        <br/>
        <p>";
                // line 63
