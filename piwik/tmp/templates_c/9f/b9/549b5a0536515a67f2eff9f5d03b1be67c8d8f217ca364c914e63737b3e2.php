...
class __TwigTemplate_9fb9549b5a0536515a67f2eff9f5d03b1be67c8d8f217ca364c914e63737b3e2 extends Twig_Template
{
    ...
    ";
        // line 8
        if (twig_length_filter($this->env, $this->getContext($context, "pluginsHavingUpdate"))) {
            // line 9
            echo "        <h2>";
            echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getContext($context, "pluginsHavingUpdate")), "html", null, true);
        ...
        ";
            // line 13
            echo $context["plugins"]->gettablePluginUpdates($this->getContext($context, "pluginsHavingUpdate"), $this->getContext($context, "updateNonce"), $this->getContext($context, "activateNonce"), 0);
            echo "
    ";
        }
        // line 15
    ...
    ";
        // line 20
        if ((!$this->getContext($context, "isPluginsAdminEnabled"))) {
            // line 21
            echo "        <br/>";
    ...
    ";
        // line 26
        echo $context["plugins"]->getpluginsFilter(false, $this->getContext($context, "isMarketplaceEnabled"));
        echo "

    ";
        // line 28
        echo $context["plugins"]->gettablePlugins($this->getContext($context, "pluginsInfo"), $this->getContext($context, "pluginNamesHavingSettings"), $this->getContext($context, "activateNonce"), $this->getContext($context, "deactivateNonce"), $this->getContext($context, "uninstallNonce"), false, $this->getContext($context, "marketplacePluginNames"), $this->getContext($context, "isPluginsAdminEnabled"));
        echo "
